"""Create joint SNP workflow report."""
import os
...
def main(args):
    """Run the entry point."""
    logger = get_named_logger("jointSNPReport")
    report = labs.LabsReport(
        "Trio small variation report", "wf-trio",
...
def argparser():
    ...
    parser = wf_parser("multisample_snp_report")
    parser.add_argument("report", help="multisample SNP report output file")
    parser.add_argument(
